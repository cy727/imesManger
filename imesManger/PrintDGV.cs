...
namespace imesManger
{
    class PrintDGV
    {
        ...
        private static bool SaveFileDialog()
        {
            ...
            saveFileDialogOutput.Filter = "excel files(*.xlsx)|*.xlsx";//excel files(*.xls)|*.xls|All files(*.*)|*.*
        ...
        private static bool SaveFileDialog(string sFileName)
        {
            SaveFileDialog saveFileDialogOutput = new SaveFileDialog();
            saveFileDialogOutput.Filter = "excel files(*.xlsx)|*.xlsx";//excel files(*.xls)|*.xls|All files(*.*)|*.*
            saveFileDialogOutput.FilterIndex = 0;
            saveFileDialogOutput.FileName = sFileName;
            saveFileDialogOutput.RestoreDirectory = true;
            saveFileDialogOutput.CreatePrompt = true;
